...
//# sourceMappingURL=local.js.map
  ...
  App = (function(superClass) {
    ...
    App.prototype.elements = {
      ...
      '#opt-logout': 'logoutEl',
      '#opt-more': 'moreEl',
      '#opt-db-saving': 'savingProgressEl'
    };
    ...
    function App() {
      ...
      this.overdue = bind(this.overdue, this);
    ...
    App.prototype.overdue = function(item) {
      var clss, dateNow, dateTimestamp, days, diff, overdue;
      clss = '';
      overdue = this.settings.Overdue;
      ...
      if (days >= (overdue.alert === true ? 1 : parseInt(overdue.alert))) {
        clss = 'info-alert';
        this.el.addClass('notice-error').removeClass('notice-info notice-warning');
      } else if (days >= (overdue.warning === true ? 1 : parseInt(overdue.warning))) {
        clss = 'info-warning';
        this.el.addClass('notice-warning').removeClass('notice-info notice-error');
      } else {
        this.el.addClass('notice-info').removeClass('notice-warning notice-error');
      }
      return clss;
    };
    ...
    App.prototype.ask = function(e) {
      ...
      res = (ref = (res = this.localeSettings[type].processAsk)) != null ? ref : {
        res: null
      };
      if (!res) {
        return;
    ...
    App.prototype.mysqlBeforeSend = function() {
      ...
      buttonTextEl = $('[data-type=' + this.data.type + ']');
      buttonTextEl.html(this.localeSettings[this.data.type].processBefore);
    ...
    App.prototype.mysqlDone = function(settings) {
      return (function(_this) {
        return function(data, state, xhr) {
          ...
          buttonTextEl.html(_this.localeSettings[_this.data.type].processDone);
          _this.savingProgressEl.addClass('hide');
          func = function() {
            _this.getMysql(_this.getToken());
            return buttonTextEl = $('[data-type=' + _this.data.type + ']').html(_this.localeSettings[_this.data.type].processDefault).attr('disabled', false);
          };
    ...
    App.prototype.mysqlFail = function() {
      return (function(_this) {
        return function(xhr, state, responseText) {
          var buttonTextEl, func;
          buttonTextEl = $('[data-type=' + _this.data.type + ']');
          buttonTextEl.html(_this.localeSettings[_this.data.type].processFail + ': ' + responseText);
          func = function() {
            return buttonTextEl = $('[data-type=' + this.data.type + ']').html(this.localeSettings[this.data.type].processDefault);
          };
          return _this.delay(func, 2000);
        };
      })(this);
  ...
  Settings = (function(superClass) {
    ...
    Settings.configure('Settings', 'Refresh', 'Error', 'Overdue');
