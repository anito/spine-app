...
if ( ! class_exists( 'wpt_spine_js' ) ) {
    ...
    class Wpt_spine_js extends Spine_js_admin {
        ...
        public function get_admin_options() {
            ...
            if (isset($options)) {
                $this->title = ! empty( $options['title'] ) ? $options['title'] : $this->title;
        ...
        public function options_validate( $new_settings ) {
            ...
            if ( isset( $new_settings['active'] ) && $new_settings['active'] == '1' ) {
        ...
        public function get_wpt_title() {
            ...
            <label class="spine-js-">
                <input id="spine_js_settings_wpt_title" name="spine_js_settings_wpt[title]" size="40" value="<?= $this->title ?>" placeholder="<?= $this->title ?>"
                        type="text"  />
            </label>
            <?php
